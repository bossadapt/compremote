...
import MacroBuilder from './components/macroBuilder/MacroBuilder.vue'
...
<template>
  ...
  <div class="nav-bar">
    <button
      :disabled="focusedPage === 0"
      :class="focusedPage === 0 ? 'nav-bar-button-macro' : 'nav-bar-button-reciever'"
      @click="focusedPage = 0"
    >
      Macro Builder
    </button>
    <button
      :disabled="focusedPage === 1"
      :class="focusedPage === 0 ? 'nav-bar-button-macro' : 'nav-bar-button-reciever'"
      @click="focusedPage = 1"
    >
      Reciever Bridge
  ...
  <MacroBuilder v-else-if="focusedPage === 0" />
  <Reciever v-else class="main-container" />
  <Popup />
</template>
